...
from util import read, get_md5, get_sha256
...
class APK(object):
    ...
    def __init__(self, filename, raw=False, mode="r", magic_file=None, zipmodule=ZIPMODULE):
        ...
        self.file_sha256 = get_sha256(self.__raw)
    ...
    def get_file_type(self, file_name):
        '''
            made by sangmin
        '''
        return magic.Magic().from_buffer(self.zip.read(file_name))
    ...
    def get_icon_files(self):
        ...
        return [icon.replace("'", '') for icon in parse_icon_rt.split('\n') if icon]
